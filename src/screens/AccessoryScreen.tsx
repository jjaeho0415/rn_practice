...
type Props = NativeStackScreenProps<RootStackParamList, 'Accessory'>;

type sortOption = '거리순' | '인기순' | '추천순' | '최저가순';
const backArrowIcon = require('../../assets/icons/arrow/backArrow.png');

const AccessoryScreen = ({ navigation, route }: Props) => {
  const categoryName = route.params.categoryName;
    const [sortOption, setSortOption] = useState<sortOption>('인기순');
    const [isSortOptionModalOpen, setIsSortOptionModalOpen] = useState<boolean>(false);
